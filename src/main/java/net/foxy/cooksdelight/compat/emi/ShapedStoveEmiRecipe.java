...
public class ShapedStoveEmiRecipe extends StoveEmiRecipe {

    public ShapedStoveEmiRecipe(ShapedStoveRecipe recipe) {
        super(padIngredients(recipe), EmiStack.of(EmiPort.getOutput(recipe)), EmiPort.getId(recipe), false, recipe.getCookingTime(), recipe.getExperience());

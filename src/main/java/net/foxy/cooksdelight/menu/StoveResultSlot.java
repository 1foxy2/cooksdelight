...
public class StoveResultSlot extends Slot {
    ...
    public StoveResultSlot(Player player, Container container, int slot, int xPosition, int yPosition) {
    ...
    protected void checkTakeAchievements(ItemStack stack) {
        ...
        if (this.player instanceof ServerPlayer serverplayer && this.container instanceof StoveContainer abstractfurnaceblockentity) {
